...
func TestAsyncHkeys(t *testing.T) {
	client := NewAsyncClient(t)
	r,e := client.Hkeys("ha")
	if e != nil {
		t.Fatal(e)
...
func TestAsyncHget(t *testing.T) {
	client := NewAsyncClient(t)
	r,e := client.Hget("ha", "k1")
	if e != nil {
		t.Fatal(e)
	}
	b, e := r.Get()
...
func TestAsyncHgetall(t *testing.T) {
	client := NewAsyncClient(t)
	r,e := client.Hgetall("ha")
	if e != nil {
		t.Fatal(e)
	}
	b, e := r.Get()
...
func TestAsyncHlen(t *testing.T) {
	client := NewAsyncClient(t)
	r,e := client.Hlen("ha")
	if e != nil {
		t.Fatal(e)
